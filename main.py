...
# Добавление директории worker в путь Python
sys.path.insert(0, os.path.join(os.path.dirname(__file__), 'worker'))


def _setup_root_logging():
    """
    Настройка корневого логгера так, чтобы все логи (включая worker.*) 
...
from worker.ui.cli_interface import main as cli_main
